...
const Loader = () => {
  return (
    <div className="pf-loader-wrapper">
      <style>{`
        .pf-loader-wrapper #svg-global {
          zoom: 1.2;
          overflow: visible;
        }

        @keyframes pf-fade-particles {
          0%, 100% { opacity: 1; }
          50% { opacity: 0.5; }
        }
        ...
        .pf-loader-wrapper #particles {
          animation: pf-fade-particles 5s infinite alternate;
        }
        .pf-loader-wrapper .particle {
          animation: pf-floatUp linear infinite;
        }

        .pf-loader-wrapper .p1 { animation-duration: 2.2s; animation-delay: 0s; }
        .pf-loader-wrapper .p2 { animation-duration: 2.5s; animation-delay: 0.3s; }
        .pf-loader-wrapper .p3 { animation-duration: 2s; animation-delay: 0.6s; }
        .pf-loader-wrapper .p4 { animation-duration: 2.8s; animation-delay: 0.2s; }
        .pf-loader-wrapper .p5 { animation-duration: 2.3s; animation-delay: 0.4s; }
        .pf-loader-wrapper .p6 { animation-duration: 3s; animation-delay: 0.1s; }
        .pf-loader-wrapper .p7 { animation-duration: 2.1s; animation-delay: 0.5s; }
        .pf-loader-wrapper .p8 { animation-duration: 2.6s; animation-delay: 0.2s; }
        .pf-loader-wrapper .p9 { animation-duration: 2.4s; animation-delay: 0.3s; }

        @keyframes pf-bounce-lines {
          0%, 100% { transform: translateY(0); }
          50% { transform: translateY(-3px); }
        }

        .pf-loader-wrapper #line-v1,
        .pf-loader-wrapper #line-v2,
        .pf-loader-wrapper #node-server,
        .pf-loader-wrapper #panel-rigth,
        .pf-loader-wrapper #reflectores,
        .pf-loader-wrapper #particles {
          animation: pf-bounce-lines 3s ease-in-out infinite alternate;
        }
        .pf-loader-wrapper #line-v2 {
